...
def seed_skill_knowledge_layer(db):
    ...
    institutes_data = [
        ...
        {"institute_code": "INST_NAS_02", "name": "Government ITI Nashik (City)", "district_id": "D002", "district_name": "Nashik", "institute_type": "Govt ITI", "capacity": 950, "enrolled": 890, "placement_rate": 81.2, "contact_email": "iti.nashikcity@mahasports.gov.in"},
        ...
        {"institute_code": "INST_NAS_01", "name": "Government ITI Nashik (Satpur)", "district_id": "D004", "district_name": "Ahmednagar", "institute_type": "Govt ITI", "capacity": 800, "enrolled": 720, "placement_rate": 69.5, "contact_email": "iti.satpur@mahasports.gov.in"},
    ...
    equipments_data = [
        ...
        {"institute_name": "Government ITI Nashik (City)", "district_id": "D002", "district_name": "Nashik", "sector_name": "IT and IT-ES", "equipment_name": "High-Performance Cloud Development Workstations", "status": "Needs Upgrade", "required_units": 30, "estimated_cost_inr": 1800000, "impact_on_training": "High"},
        {"institute_name": "Government ITI Nashik (City)", "district_id": "D002", "district_name": "Nashik", "sector_name": "Healthcare", "equipment_name": "Advanced Patient Simulator & ICU Bed Setup", "status": "Missing", "required_units": 2, "estimated_cost_inr": 650000, "impact_on_training": "High"},
    ...
    trainers_data = [
        ...
        {"trainer_name": "Amit Kulkarni", "institute_name": "Government ITI Nashik (City)", "district_id": "D002", "district_name": "Nashik", "sector_name": "IT and IT-ES", "specialization": "Core Java & HTML/CSS", "experience_years": 6, "certified": "Yes", "upskilling_needed": "Modern React 18, Node.js Microservices, AWS Cloud Practitioner", "training_status": "Upskilling Scheduled"},
        {"trainer_name": "Dr. Meenakshi Joshi", "institute_name": "Government ITI Nashik (City)", "district_id": "D002", "district_name": "Nashik", "sector_name": "Healthcare", "specialization": "General Nursing & First Aid", "experience_years": 14, "certified": "Yes", "upskilling_needed": "ICU Ventilator Basics, Electronic Health Records (ABDM)", "training_status": "Active"},
    ...
    batches_data = [
        ...
        {"batch_code": "BATCH-NAS-IT-2023A", "institute_name": "Government ITI Nashik (City)", "course_name": "Full Stack Web Development", "sector_name": "IT and IT-ES", "district_name": "Nashik", "enrolled_count": 60, "certified_count": 55, "placed_count": 48, "pass_rate": 91.6, "placement_rate": 80.0, "avg_salary_pm": 28000},
        {"batch_code": "BATCH-NAS-HLTH-2023C", "institute_name": "Government ITI Nashik (City)", "course_name": "General Duty Healthcare Assistant", "sector_name": "Healthcare", "district_name": "Nashik", "enrolled_count": 40, "certified_count": 39, "placed_count": 35, "pass_rate": 97.5, "placement_rate": 87.5, "avg_salary_pm": 20000},
    ...
    outcomes_data = [
        ...
        {
            "employer_name": "Wockhardt Hospitals",
            "sector_name": "Healthcare",
            ...
            "employer_feedback": "Punctual, disciplined, and very empathetic. Highly recommend increasing batch capacity by 50% in Nashik.",
