...
export default function GovernmentDashboard({ selectedDistrict, setSelectedDistrict }) {
  ...
  const [districtId, setDistrictId] = useState(selectedDistrict === 'Mumbai Suburban' ? 'D002' : selectedDistrict === 'Nagpur' ? 'D003' : 'D001');
      ...
      <div className="portal-header government-gradient">
        ...
        <div className="district-filter-control">
          ...
          <select
            ...
            onChange={e => {
              ...
              if (setSelectedDistrict) {
                ...
                if (e.target.value === 'D002') setSelectedDistrict('Mumbai Suburban');
          ...
          >
            ...
            <option value="D002">Mumbai Suburban</option>
        ...
        <div className="card animate-slide-up">
          <div className="policy-brief-header">
            <div>
              ...
              <h3>Executive Policy Advisory for {districtId === 'D001' ? 'Pune' : districtId === 'D002' ? 'Mumbai Suburban' : 'Nagpur'}</h3>
